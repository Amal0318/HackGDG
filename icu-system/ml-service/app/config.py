...
# Training paths (not used in production)
DATA_DIR_A = 'training/training_setA'
DATA_DIR_B = 'training/training_setB'
OUTPUT_DIR = 'outputs'

# Production model paths (Docker container)
MODEL_SAVE_PATH = 'app/models/model.pth'
SCALER_SAVE_PATH = 'app/models/scaler.pkl'
CONFIG_SAVE_PATH = 'app/models/feature_config.json'
CHECKPOINT_DIR = 'outputs/checkpoints'

# Simulator to model feature mapping
